...
int main(void)
{
  ...
  MX_RTC_Init();
  /* USER CODE BEGIN 2 */
  //HAL_UART_Transmit(&huart1, tem, sizeof(tem), 200);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6|GPIO_PIN_7|Mems_VL53_xshut_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PH6 PH7 Mems_VL53_xshut_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_7|Mems_VL53_xshut_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(EXTI11_IRQn, 1, 0);
